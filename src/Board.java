...
public class Board extends JPanel implements KeyListener, MouseListener, MouseMotionListener {
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int row = 0; row < nextShape.getCoordis().length; row++) {
            for (int col = 0; col < nextShape.getCoordis()[0].length; col++) {
                if (nextShape.getCoordis()[row][col] != 0) {
    ...
    public void setNextShape() {
        ...
        nextShape = new Shape(shapes[index].getCoordis(), this, colors[colorIndex]);
    }
    ...
    public void setCurrentShape() {
        ...
        for (int row = 0; row < currentShape.getCoordis().length; row++) {
            for (int col = 0; col < currentShape.getCoordis()[0].length; col++) {
                if (currentShape.getCoordis()[row][col] != 0) {
